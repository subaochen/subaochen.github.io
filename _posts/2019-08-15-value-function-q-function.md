...
![policy](https://raw.githubusercontent.com/subaochen/subaochen.github.io/master/images/rl/mdp/policy.png){: .center-image }
...
$$
r+\gamma \mathbb{E}[G_{t+1}|S_{t+1}=s']=r+\gamma v_{\pi}(s')
$$
